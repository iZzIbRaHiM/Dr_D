        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          <div>
            <Link to="/" className="inline-flex items-center gap-3">
              <img src="/NewLogo.png" alt="Dr D Academy" className="h-12 w-auto flex-shrink-0" />
              <span className="font-serif text-2xl font-bold text-foreground gold-gradient-text">Dr D Academy</span>
            </Link>
